...
defaultSettings:
  ...
  taintToleration: ~
  systemManagedComponentsNodeSelector: "node-role.kubernetes.io/edge: "
  priorityClass: ~
  autoSalvage: ~
...
```
helm install longhorn longhorn/longhorn   --namespace longhorn-system   --create-namespace   --values longhorn_values_1.3.1.yaml
```
