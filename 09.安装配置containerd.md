...
mkdir cni-plugins
tar -xvf /stage/cni-plugins-linux-amd64-v1.1.1.tgz -C cni-plugins
...
for node_ip in ${NODE_IPS[@]}
  do
    echo ">>> ${node_ip}"
    scp containerd/bin/*  crictl  cni-plugins/*  root@${node_ip}:/usr/local/kubernetes/bin
    scp runc nerdctl  root@${node_ip}:/usr/local/bin
